<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managerenter.aspx.cs" Inherits="user_profiledetails" %>
  ...
  <form id="Form1" runat="server">
    <nav>
      ...
      <div class="profile-details">
        ...
        <br />father name:
        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("fathername") %>' />
        <br />mail:
        ...
        <br />
        father name:
        <asp:Label ID="Label1" runat="server" Text='<%# Eval("fathername") %>' />
        <br />
        mail:
        <asp:Label ID="mailLabel" runat="server" Text='<%# Eval("mail") %>' />
        <br />
